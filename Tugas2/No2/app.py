...
@app.route('/')
def index():
    pegawai_tetap = PegawaiTetap("Tika Sari", "13597", "A", 5000000)
    pegawai_harian = PegawaiHarian("Adi Prayoga", "72811", "B", 120, 5000)
    pegawai_kontrak = PegawaiKontrak("Aditya", "91573", "C", 6, 2000000)
